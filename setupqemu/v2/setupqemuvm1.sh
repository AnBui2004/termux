...
cd
echo "sed -i \"/start"$setname"/d\" $PREFIX/var/lib/proot-distro/containers/debian/rootfs/etc/profile" > "start"$setname".sh"
...
echo "echo '/root/start"$setname".sh' >> $PREFIX/var/lib/proot-distro/containers/debian/rootfs/etc/profile" >> start"$setname".sh
echo "proot-distro login debian" >> start"$setname".sh
chmod +rwx start"$setname".sh
clear
echo -e '\e[1;37m[i] Logging in...\e[0m'
proot-distro login debian
rm $PREFIX/var/lib/proot-distro/containers/debian/rootfs/root/setup"$setname".sh
