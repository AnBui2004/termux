...
if [ -e "/usr/local/bin/qemu-system-arm-aipt1g" ]; then
    ...
    apt update
    apt upgrade -y
    apt install libx11-6 libxxf86vm1 libgl1 libpixman-1-0 libepoxy0 libsnappy1v5 liblzo2-2 libpng16-16 libjpeg62 libgnutls30 libsdl2-2.0-0 libvdeplug2 libvte-2.91-0 libsdl2-image-2.0-0 libjack0 libsndio7.0 libcurl4 libssh-4 libspice-server1 libslirp0 libvirglrenderer1 libusbredirparser1 pulseaudio libcapstone4 libbpf0 libusb-1.0-0 liburing1 libfuse3-3 libaio1 libnfs13 -y
...
cd
curl -o "start"$setname".sh" https://raw.githubusercontent.com/AnBui2004/termux/refs/heads/main/setupqemu//v2/ipod/1g/startqemuvm.sh
