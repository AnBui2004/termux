...
if [ -e "/usr/local/bin/qemu-system-arm-aipt2g" ]; then
    echo "qemu-system-arm-aipt2g is already installed."
...
echo -e '\e[1;37m-\e[0m'
echo -e '\e[1;37mThe necessary files are in the VM folder in Debian. Please do not delete the files there if you still use them.\e[0m'
echo -e '\e[1;37m-\e[0m'
rm "setup"$setname".sh"
