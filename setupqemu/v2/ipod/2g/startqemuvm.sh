...
clear
echo -e "\e[1;37m--------------------"
echo -e "\e[1;37mDo you want to run Apple iPod Touch 2G emulator now? Enter the corresponding number and press enter to start. Enter nothing and press enter to exit and continue using Debian 11."
echo -e "\e[1;37m--------------------"
