...
cd $PREFIX/var/lib/proot-distro/containers/"$prootdistroname"/rootfs/root
if [[ "$prootdistroname" =~ "alpine" ]]; then
...
rm $PREFIX/var/lib/proot-distro/containers/"$prootdistroname"/rootfs/root/setup"$setname".sh
