...
clear
echo -e "\e[1;37m--------------------"
echo -e "\e[1;37mDo you want to run Windows Whistler build 2257 now? Enter the corresponding number and press enter to start. Enter nothing and press enter to exit and continue using Debian."
echo -e "\e[1;37m--------------------"
