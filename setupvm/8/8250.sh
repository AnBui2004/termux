...
setfileurl='https://archive.org/download/windows-8-build-8250.7znbab/Windows%208%20build%208250.7z'
setfileurl2='https://go.anbui.ovh/termux/qemu/windows/nt6/Windows%208%20build%208250.7z'
