...
setfileurl='https://pixeldrain.com/api/file/vgmw46W2?download'
setfileurl2='https://archive.org/download/windows-8-build-8400.7znbab/Windows%208%20build%208400.7z'
setfileurl3='https://go.anbui.ovh/termux/qemu/windows/nt6/Windows%208%20build%208400.7z'
