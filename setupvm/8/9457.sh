...
setfileurl='https://pixeldrain.com/api/file/LQhErskk?download'
setfileurl2='https://archive.org/download/windows-8.1-build-9457.7znbab/Windows%208.1%20build%209457.7z'
setfileurl3='https://go.anbui.ovh/termux/qemu/windows/nt6/Windows%208.1%20build%209457.7z'
