...
setfileurl='https://archive.org/download/windows-8-build-7785.7znbsb/Windows%208%20build%207785.7z'
setfileurl2='https://go.anbui.ovh/termux/qemu/windows/nt6/Windows%208%20build%207785.7z'
