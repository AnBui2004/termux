...
setfileurl='https://pixeldrain.com/api/file/4GFER6Ah?download'
setfileurl2='https://archive.org/download/limbo-pc-emulator-images-9-nbab/Windows%20Whistler%20build%202446.7z'
setfileurl3='https://go.anbui.ovh/termux/qemu/windows/nt5/Windows%20Whistler%20build%202446.7z'
