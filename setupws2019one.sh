...
wget -O a.7z 'https://www.googleapis.com/drive/v3/files/1uLwTeoek-MXhImbJnQDGa14FOKZyvOne?alt=media&key=AIzaSyBg5cJ4QZF7kDgco9Sxrs-cPtV3F65bVSY'
7z x a.7z
rm a.7z
cd
clear
