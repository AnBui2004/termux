...
wget -O a.7z 'https://www.googleapis.com/drive/v3/files/1CFNWrX44MqDXCRUaRzZq2rV4yBf60I9l?alt=media&key=AIzaSyBg5cJ4QZF7kDgco9Sxrs-cPtV3F65bVSY'
7z x a.7z
rm a.7z
cd
clear
