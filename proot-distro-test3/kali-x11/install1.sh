...
aria2c -o installkali.sh https://raw.githubusercontent.com/AnBui2004/termux/refs/heads/main/proot-distro-test3/kali-x11/install2.sh
...
cd
echo "sed -i \"/com.termux.x11/d\" $PREFIX/var/lib/proot-distro/containers/kali-rolling/rootfs/home/kaliroom/.profile" > "startkali.sh"
echo "sed -i \"/termux-x11/d\" $PREFIX/var/lib/proot-distro/containers/kali-rolling/rootfs/home/kaliroom/.profile" >> "startkali.sh"
echo "echo 'am start --user 0 -n com.termux.x11/com.termux.x11.MainActivity' >> $PREFIX/var/lib/proot-distro/containers/kali-rolling/rootfs/home/kaliroom/.profile" >> startkali.sh
echo "echo 'termux-x11 -xstartup \"fluxbox\" &' >> $PREFIX/var/lib/proot-distro/containers/kali-rolling/rootfs/home/kaliroom/.profile" >> startkali.sh
