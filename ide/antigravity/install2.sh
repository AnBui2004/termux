...
echo -e '\e[1;37m-\e[0m'
echo -e "\e[1;37mUse this command to run: \"./antigravity.sh\"\e[0m"
echo -e '\e[1;37m-\e[0m'
rm /etc/profile.d/installantigravity.sh
rm /data/data/com.termux/files/home/installantigravity.sh