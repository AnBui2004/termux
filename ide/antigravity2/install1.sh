...
mkdir -p Apps/IDE
cd Apps/IDE
aria2c -x 4 -o Antigravity.tar.gz https://storage.googleapis.com/antigravity-public/antigravity-hub/2.8.1-6512087774658560/linux-arm/Antigravity.tar.gz
clear
...
EOF
aria2c -o startantigravity.sh https://raw.githubusercontent.com/AnBui2004/termux/refs/heads/main/ide/antigravity2/startantigravity.sh
aria2c -o uninstall.sh https://raw.githubusercontent.com/AnBui2004/termux/refs/heads/main/ide/antigravity2/uninstall.sh
...
aria2c -o installantigravity.sh https://raw.githubusercontent.com/AnBui2004/termux/refs/heads/main/ide/antigravity2/install2.sh
...
chmod +x antigravity.sh
cd
echo "sed -i \"/startantigravity.sh/d\" $PREFIX/var/lib/proot-distro/containers/debiandevroom/rootfs/home/devroom/.profile" > "antigravity.sh"
echo "echo '/Apps/IDE/Antigravity/startantigravity.sh' >> $PREFIX/var/lib/proot-distro/containers/debiandevroom/rootfs/home/devroom/.profile" >> antigravity.sh
echo "clear" >> antigravity.sh
echo "proot-distro login debiandevroom --user devroom" >> antigravity.sh
echo "clear" >> antigravity.sh
chmod +x antigravity.sh
clear
